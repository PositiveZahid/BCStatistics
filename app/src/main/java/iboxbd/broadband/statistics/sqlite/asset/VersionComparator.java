package iboxbd.broadband.statistics.sqlite.asset;
...
import iboxbd.broadband.statistics.sqlite.SqliteAsset;
...
public class VersionComparator implements Comparator<String> {
    ...
    private static final String TAG = SqliteAsset.class.getSimpleName();
     ...
     *
     * @exception SqliteAsset.SQLiteAssetException
    ...
    public int compare(String file0, String file1) {
        ...
        if (!m0.matches()) {
            ...
            throw new SqliteAsset.SQLiteAssetException("Invalid upgrade script file");
        }
